...
En las siguientes secciones, se hará una exposición a detalle de cada uno de los elementos del modelo, sin embargo, en la Figura \ref{fig:DiagramaMod} se hace una representación visual para su mejor comprensión.
...
\end{tikzpicture}
\caption{Diagrama esquemático del modelo}
